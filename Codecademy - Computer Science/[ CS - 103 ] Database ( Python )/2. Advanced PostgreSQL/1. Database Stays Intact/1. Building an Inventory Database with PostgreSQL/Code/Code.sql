...
UPDATE parts
SET description = 'UNKNOW'
WHERE description IS NULL;

ALTER TABLE parts
ALTER COLUMN description SET NOT NULL;

INSERT INTO parts (id, description, code, manufacturer_id) VALUES (54, 'Wires', 'V1-009', 9);
...
ALTER TABLE reorder_options
ADD CHECK (price_usd > 0 AND price_usd > 0);

ALTER TABLE reorder_options
ADD CHECK (quantity > 0 AND quantity > 0);
